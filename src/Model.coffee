...
Model = module.exports = (@_clientId = '', AdapterClass = MemorySync) ->
  ...
  pending = {}
  pendingTimeout = null
  # Handles transactions received from the parent replica.
  # The txn was either generated by this browser or
  # another browser.
  self._onTxn = (txn) ->
  ...
  # Handles transaction errors received from the parent replica
