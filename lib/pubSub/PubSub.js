...
PubSub.prototype.subscribe = function subscribe (subscriberId, channels, cb) {
  ...
  for (var i = numChannels; i--; ) {
    ...
    if (! type) {
      // TODO Consider return or throw later
      cb(null);
      console.warn('Channel ' + channel + ' does not match a channel type; subscriberId ' + subscriberId);
      console.log('All channels in same request');
