...
Model.prototype.setNull = function() {
  ...
  var segments = this._resolvePath(subpath);
  this._setNull(segments, value, cb);
};
...
Model.prototype.increment = function() {
  ...
  var segments = this._resolvePath(subpath);
  this._increment(segments, byNumber, cb);
};
...
Model.prototype.unshift = function() {
  ...
  var segments = this._resolvePath(subpath);
  this._unshift(segments, value, cb);
};
...
Model.prototype.insert = function() {
  ...
  var segments = this._resolvePath(subpath);
  this._insert(segments, value, cb);
};
...
Model.prototype.move = function() {
  ...
  var segments = this._resolvePath(subpath);
  this._move(segments, from, to, howMany, cb);
};
...
Model.prototype.stringInsert = function() {
  ...
  var segments = this._resolvePath(subpath);
  this._stringInsert(segments, index, value, cb);
};
Model.prototype._stringInsert = function(segments, index, value, cb) {
  var model = this;
...
Model.prototype.stringRemove = function() {
  ...
  var segments = this._resolvePath(subpath);
  this._stringRemove(segments, index, howMany, cb);
};
