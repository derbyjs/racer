...
Model.prototype._mutate = function(subpath, fn, cb) {
  ...
  return fn(doc, segments, docSegments, cb);
};
...
Model.prototype.set = function(subpath, value, cb) {
  var model = this;
  function set(doc, segments, docSegments, fnCb) {
...
Model.prototype.setNull = function(subpath, value, cb) {
  var model = this;
  function setNull(doc, segments, docSegments, fnCb) {
...
Model.prototype.del = function(subpath, cb) {
  var model = this;
  function del(doc, segments, docSegments, fnCb) {
...
Model.prototype.increment = function(subpath, byNumber, cb) {
  ...
  var model = this;
  function increment(doc, segments, docSegments, fnCb) {
...
Model.prototype.push = function(subpath, value, cb) {
  var model = this;
  function push(doc, segments, docSegments, fnCb) {
...
Model.prototype.unshift = function(subpath, value, cb) {
  var model = this;
  function unshift(doc, segments, docSegments, fnCb) {
...
Model.prototype.insert = function(subpath, index, values, cb) {
  var model = this;
  function insert(doc, segments, docSegments, fnCb) {
...
Model.prototype.pop = function(subpath, cb) {
  var model = this;
  function pop(doc, segments, docSegments, fnCb) {
...
Model.prototype.shift = function(subpath, cb) {
  var model = this;
  function shift(doc, segments, docSegments, fnCb) {
    var arr = doc.get(docSegments);
    var length = arr && arr.length;
    if (!length) {
      fnCb();
...
Model.prototype.remove = function(subpath, index, howMany, cb) {
  ...
  var model = this;
  function remove(doc, segments, docSegments, fnCb) {
...
Model.prototype.move = function(subpath, from, to, howMany, cb) {
  if (howMany == null) howMany = 1;
  var model = this;
  function move(doc, segments, docSegments, fnCb) {
...
Model.prototype.stringInsert = function(subpath, index, value, cb) {
  var model = this;
  function stringInsert(doc, segments, docSegments, fnCb) {
...
Model.prototype.stringRemove = function(subpath, index, howMany, cb) {
  var model = this;
  function stringRemove(doc, segments, docSegments, fnCb) {
