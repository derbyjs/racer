...
Model.prototype.filter = function(input, options, fn) {
...
Model.prototype.sort = function(input, options, fn) {
  if (typeof fn === 'undefined') {
    fn = options;
    options = null;
  }
  var inputPath = this.path(input);
  return this.root._filters.add(inputPath, null, fn || 'asc', options);
};
